...
export default function Footer() {
  ...
  return (
  <footer className="relative mt-0 pt-12 bg-white/10 dark:bg-black/10 backdrop-blur-sm border-t border-white/20 dark:border-white/10">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid gap-12 lg:gap-16 md:grid-cols-3 text-center md:text-left">
          {/* Brand / identity section - displays club logo, name, and brief description */}
          ...
          {/* Navigation section - contains footer navigation links to main pages */}
          <nav aria-label="Navigation pied de page" className="space-y-4">
            <h3 className="font-semibold tracking-wide text-sm uppercase opacity-90">Club</h3>
                  ...
                  <li key={l.href}>
                    <Link
                      ...
                      className={`group relative inline-flex items-center rounded-full px-4 py-2 text-sm transition motion-safe:duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-success-500 focus-visible:ring-offset-2
                        ${active
                          ? "bg-brand-500/20 ring-1 ring-brand-500/30 font-semibold"
                          : "opacity-80 hover:bg-white/10 dark:hover:bg-black/20 hover:opacity-100"}`}
                    >
          ...
          {/* Trial / contact section - information about trial classes and contact call-to-action */}
          <div className="space-y-4">
        ...
        {/* Divider section - visual separator between main footer content and bottom bar */}
        ...
        {/* Bottom bar section - copyright notice and technology attribution */}
